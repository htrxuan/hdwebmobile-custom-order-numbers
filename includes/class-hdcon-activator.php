...
class HDCON_Activator
{

    public static function activate()
    {
        if (!self::is_woocommerce_active()) {
            deactivate_plugins(plugin_basename(HDCON_PLUGIN_FILE));
            set_transient('hdcon_wc_missing_notice', true, 30);
            return;
        }
        ...
        // 'hdcon_db_version' option -- see hdwebmobile-wholesale-pricing or
